...
<html xmlns="http://www.w3.org/1999/xhtml" lang="de" prefix="og: http://ogp.me/ns#">
    <head>
        <title>Unterstützer — Jugend Rettet</title>
        ...
        <meta property="og:url" content="http://de.jugendrettet.org/unterstuetzer" />
                ...
                <footer>
                    ...
                    <nav class="footer">
                        <ul>
                            ...
                            <li class="br"></li>
                            <li style="box-shadow: 0 1px #fff;"><a href="unterstuetzer">Unterstützer</a></li>
                            <li class="br"></li>
