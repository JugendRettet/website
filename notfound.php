...
<html xmlns="http://www.w3.org/1999/xhtml" lang="de" prefix="og: http://ogp.me/ns#">
	...
	<div id="wrap" class="start">
        <header>
            ...
            <div id="union">
                <p class="cushycms"><span style="font-size: 2em;">404</span><br>Diese Seite existiert nicht.<br><span style="font-size:0.5em;">This page doesn't exist.</span><hr class="wide">
