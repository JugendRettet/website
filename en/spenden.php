                    ...
                    <div class="column hideme" style="min-width: 300px;">
                        ...
                        <div id="schiff-ani">
                            ...
                            <div id=schiff-container style="min-height:133px;width:300px;">
                                ...
                                <div class="blink balken" id="schiff-gespendet" style="position:absolute;overflow:hidden;width:calc(300px * 41671 / 80000);">
                                ...
                                <div style="position:absolute;width:300px">
                                    <!--<span id="0" class="unterteilungen">0m</span>-->
                                    <span id="stand" class="spendenstand schiff" style="white-space: nowrap;position:absolute;left: calc(-15px + 300px*41671/80000)">41.7 Tsd. €</span>
                                </div>
                            </div>
                        </div>
                        <br><br>
