...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" prefix="og: http://ogp.me/ns#">
    <head>
        ...
        <link href="http://jugendrettet.org/css/main.css?1" rel="stylesheet" type="text/css">
        <link href="http://jugendrettet.org/css/desktop.css?0" media="screen and (min-width: 851px)" rel="stylesheet" type="text/css">
        <link href="http://jugendrettet.org/css/mobile.css?0" media="screen and (max-width: 850px)" rel="stylesheet" type="text/css">
                    ...
                    <div class="column hideme" style="min-width: 300px;">
                        ...
                        <div id="schiff-ani">
                            ...
                            <div id=schiff-container style="min-height:133px;width:300px;">
                                ...
                                <div class="blink balken" id="schiff-gespendet" style="padding:5px;position:absolute;overflow:hidden;width:calc(300px * 25835 / 80000);">
                                ...
                                <div style="position:absolute;width:300px">
                                    <!--<span id="0" class="unterteilungen">0m</span>-->
                                    <span id="stand" class="spendenstand schiff" style="white-space: nowrap;position:absolute;left: calc(-15px + 300px*25835/80000)">25.8 Tsd. €</span>
                                </div>
                            </div>
                        </div>
                        <br><br>
