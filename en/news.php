	    ...
	    <div id="wrap">
            ...
            <div class="popup-flat">
                ...
                <div class="container double">
                    <div class="column">
                        <h4>15/10/2015</h4>
                        <p>At our meeting yesterday, we talked a lot. Especially about the German Marine mission on the mediterranean. For 6 weeks two vessels of the German Marine had been solely used for the recue of ships in distress. From now on these ships are supposed to be part of the EU-mission "Sophia", an operation trying to destroy a network of smugglers. We are researching on the backgrounds of this decision and we already met with a representative of the ministry of defence to discuss this issue. Shortly there will be an interview with a representative of the Bundeswehr.<br>These open meetings will keep you up to date, so stay tuned.</p><br>
                        <h4>12/10/2015</h4>
                        <p>We are currently in Nurnberg with our local <a href="aendern#botschafter">Ambassador</a> and we're running the first flyer campaign.</p>
                        ...
                        <h4>03/10/2015</h4>
                        <p>Our first open meeting was a success. A big Thank You to everyone who showed up.</p>
                    <p>There will be more meetings like this one in the future. Anyone who knows of locations in Berlin and other German Cities: please send us an e-mail to <a href="mailto:info@jugendrettet.org" class="link">info@jugendrettet.org</a> and tell us about them.</p>
                    ...
                    <div class="column">
                        <h4>Keep up</h4>
                        <p>What's new at <i>Jugend Rettet</i>? You can learn about changes and progress right here. Subscribe to our newsletter and visit us on <a href="https://www.facebook.com/JugendRettet" class="link">Facebook</a> and <a href="https://twitter.com/jugendrettet" class="link">Twitter</a>.</p><br>
