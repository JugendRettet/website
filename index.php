...
<html xmlns="http://www.w3.org/1999/xhtml" lang="de" prefix="og: http://ogp.me/ns#">
    <head>
        ...
        <link rel="stylesheet" href="http://jugendrettet.org/css/desktop.css?1" media="screen and (min-width: 851px)" type="text/css" />
        <link rel="stylesheet" href="http://jugendrettet.org/css/mobile.css?3" media="screen and (max-width: 850px)" type="text/css" />
        <!--[if IE]>
