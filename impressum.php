...
<html xmlns="http://www.w3.org/1999/xhtml" lang="de" prefix="og: http://ogp.me/ns#">
    <head>
        <title>Impressum — Jugend Rettet</title>
        ...
        <meta property="og:url" content="https://jugendrettet.org/impressum" />
        ...
        <link rel="alternate" hreflang="en" href="http://en.jugendrettet.org/impressum" />
            ...
            <div class="popup-flat">
                ...
                <div class="container triple">
                    <div class="scroller triple">
                        ...
                        <div class="column">
                            <h4>Urheberrecht</h4>
                            <p>Die durch die Seitenbetreiber_innen erstellten Inhalte und Werke auf diesen Seiten unterliegen dem deutschen Urheberrecht. Die Vervielfältigung, Bearbeitung, Verbreitung und jede Art der Verwertung außerhalb der Grenzen des Urheberrechtes bedürfen der schriftlichen Zustimmung der jeweiligen Autor_innen bzw. Ersteller_innen. Downloads und Kopien dieser Seite sind nur für den privaten, nicht kommerziellen Gebrauch gestattet. Soweit die Inhalte auf dieser Seite nicht von den Betreiber_innen erstellt wurden, werden die Urheberrechte Dritter beachtet. Insbesondere werden Inhalte Dritter als solche gekennzeichnet. Sollten Sie trotzdem auf eine Urheberrechtsverletzung aufmerksam werden, bitten wir um einen entsprechenden Hinweis. Bei Bekanntwerden von Rechtsverletzungen werden wir derartige Inhalte umgehend entfernen.</p>
                        </div>
                    </div>
                </div>
            </div>
