...
<html xmlns="http://www.w3.org/1999/xhtml" lang="de" prefix="og: http://ogp.me/ns#">
    <head>
        <title>Retten — Jugend Rettet</title>
        ...
        <meta property="og:url" content="http://jugendrettet.org/aendern" />
                        ...
                        <div class="tint">
                            <div class="helper">
                                ...
                                <div class="description">
                                    <p>Bring dich mit eigenen Ideen und Vorschlägen ein.</p>
                                </div>
                            </div>
                        </div></div>
                    </div>
                    <div class="child" id="warum"><div class="show" id="tun" style="height: 100%;">
                        <div class="tint">
                            <div class="helper">
                                ...
                                <hr class="narrow">
                                <div class="description">
                                    <p>Hier findest du alle Informationen, um dich konkret bei uns zu engagieren.</p>
                                </div>
                            </div>
                        </div></div>
                    </div>
                    <div class="child" id="wie"><a href="spenden">
                        <div class="tint">
                            <div class="helper">
                                ...
                                <hr class="narrow">
                                <div class="description">
                                    <p>Jede finanzielle Unterstützung bringt uns der ersten Rettungsmission näher.</p>
                                </div>
                            </div>
                        </div>
                    </a></div>
                ...
                <footer>
                    ...
                    <nav class="footer">
                        <ul>
                            ...
                            <li class="br"></li>
                            <li><a href="http://en.jugendrettet.org/aendern">en</a></li>
                        </ul>
                    </nav>
                </footer>
            </div>
